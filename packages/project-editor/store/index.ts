...
export class ProjectStore {
    ...
    buildImportedExtensions(project: Project) {
        // Collect all unique extension names from this project AND all
        // currently-open projects. This ensures that after a full load the
        // palette reflects every project's extensions, even when an imported
        // project without extensions is deserialized last and would otherwise
        // overwrite the maps with an empty set.
